...
def update_stopWords_list():
    ...
    [stopWords.append(word) for word in new_set if word not in stopWords]
...
def preprocess(tweetText):
    ...
    for tweet_text in tweetText:
        ...
        cleanTexts.append({"tweetId": tweet_text["tweetId"], "tweetText": tweet_text["tweetText"], "tweetClean": cleanTweet})
